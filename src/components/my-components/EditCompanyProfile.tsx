...
export function DialogDemo({CompanyId} : {CompanyId : string} ) {
      ...
      if (!avatarImage) {
        if (data.headline.trim() !== "") {
          ...
          const Response = await axios.post<ApiResponse>(
            `/api/company/update-company-headline?companyId=${CompanyId}`,
            {
        ...
        if (data.headline.trim() !== "") {
          ...
          const AvatarResponse = await axios.post<ApiResponse>(
            `/api/company/update-company-avatar?companyId=${CompanyId}`,
            formData,
            {
              headers: {
